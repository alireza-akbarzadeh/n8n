...
interface BaseExecuationNodeProps extends NodeProps {
...
export const BaseExecuationNode = React.memo(function (props: BaseExecuationNodeProps) {
...
BaseExecuationNode.displayName = "BaseExecuationNode";
